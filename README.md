...
| [`/jsx-artifact`](skills/jsx-artifact/) | Generate self-contained JSX artifacts as single HTML files -- React + Tailwind, no build step, works on any platform with a browser |
